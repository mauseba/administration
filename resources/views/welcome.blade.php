        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://caci-bc.org/french-courses/?lang=en"
                    ...
                    <a href="https://caci-bc.org/volunteering/?lang=en"
                        class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                    ...
                    <a href="https://caci-bc.org/?lang=en"
                        class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            <div
                                class="h-16 w-16 bg-red-50 dark:bg-red-800/20 flex items-center justify-center rounded-full">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <div id="columnas" class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                <li><strong>Contact us anytime</strong> <br>
                                    514 856-3511 <br>
                                    rendezvous@caci-bc.org <br>
                                </li>
                                <li><strong>Business hours</strong> <br>
                                    Monday to Friday, 8:30 am to 9:30 pm <br>
                                    By appointment after 5 pm <br>
                                </li>
                                <li><strong>Adresse</strong> <br>
                                    12049, boulevard Laurentien <br>
                                    Montréal (Québec) H4K 1M8</li>
                            </div>
